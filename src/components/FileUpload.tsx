        ...
        >
            ...
            >
                ...
                <button
                    ...
                    className="mt-6 rounded-xl bg-indigo-600 px-6 py-3 text-base font-semibold text-white shadow-md shadow-indigo-300 transition hover:-translate-y-0.5 hover:bg-indigo-700"
                >
                    {buttonLabel}
                </button>
                {helperText ? (
